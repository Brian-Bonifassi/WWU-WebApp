        ...
        {width !== 0 && (
          <>
            {isLandscape ? (
              <img
                src={splashImageSrc}
                className='w-[100%] h-[100vh] absolute  object-top '
                alt=''
              />
            ) : (
              <img
                src={splashImageSrc}
                className='w-[100%] h-[100vh] absolute  object-cover '
                alt=''
              />
            )}
            ...
            <div className='w-[100vw] h-[100vh] absolute  z-20 flex flex-col items-center justify-around '>
              {isMobile ? (
                <div className='w-[2rem] h-[8rem]  bg-transparent '></div>
              ) : null}
              {isLandscape ? (
                <img src={'/logo.png'} className='w-[30vw]' />
              ) : (
                <img src={'/logo.png'} className='w-[80vw] ' />
              )}
              {!isMobile ? (
                <div className='w-[2rem] h-[20rem]  bg-transparent '></div>
              ) : null}
